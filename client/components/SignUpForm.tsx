    ...
    return (
      <form className="w-1/2 h-auto rounded-lg bg-white p-6 shadow-lg" onSubmit={onSubmitForm}>
        ...
        <div className="mb-4">
          ...
          <input onChange={e => setUsername(e.target.value)} value={username} type="text" id="username" className="text-black w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-red-700" placeholder="Enter your email" />
        </div>
        ...
        <button type="submit" className="w-full bg-red-700 text-white py-2 rounded-lg hover:bg-red-900 focus:outline-none">Sign Up</button>
      </form>
    );
  }
