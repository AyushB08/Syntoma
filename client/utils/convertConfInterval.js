const convertConfInterval = (interval, modeltype) => {
    if (modeltype === "knee") {
        ...
        if (interval === "confidence_1") {
            ...
            return { text: "No Finding", subtext: "Our model does not detect any significant abnormalities in this X-ray image. Further medical evaluation is recommended." };
        ...
        } else if (interval === "confidence_14") {
