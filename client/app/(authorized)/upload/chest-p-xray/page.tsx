...
import ChestDiagnosis from "@/components/chest_p/ChestPDiagnosis";
...
import ConfidenceIntervals from "@/components/chest_p/ConfidenceIntervals";
            ...
            {fileUrl ? (
                <>
                    <div className="flex flex-row items-center justify-center space-x-4 ">
                        ...
                        <ChestDiagnosis fileurl={fileUrl} onReportSaved={handleReportSaved} />
